...
titlecol:;destination
	dc.w $656,$FFF,$EEE,$DDD,$CBB,$CAA,$B99,$A88
	dc.w $977,$877,$766,$655,$644,$533,$433,$321
	dc.w $FFF,$EEE,$CCD,$BBC,$AAB,$99B,$88A,$779
	dc.w $668,$557,$446,$335,$335,$224,$223,$112
...
titlepic:	incbin	"data/titlepic6.blt"
dcb.b	40*5*16,0
...
mod_smpl1:
	incbin	"data/modules/smp.1_diznee_moods.term"
even
mod_smpl2:
	incbin	"data/modules/smp.2_2_years_crest.term"
even
mod_smpl3:
	incbin	"data/modules/smp.3_last_ninja_moods.term"
even
mod_smpl4:
	incbin	"data/modules/smp.4_deeper_gates_of_doh.term"
even
mod_smpl5:
	incbin	"data/modules/smp.5_mazemania(pink).term"
even
mod_smpl6:
	incbin	"data/modules/smp.6_gone_too_soon...term"
even
mod_smpl7:
	incbin	"data/modules/smp.7_enough_memory?.pre.term"
even
mod_smpl8:
	incbin	"data/modules/smp.8_an_apology.term"
even
...
mod_data1:                          
	incbin	"data/modules/P60.1_diznee_moods"
mod_data2:                          
	incbin	"data/modules/P60.2_2_years_crest"
mod_data3:                          
	incbin	"data/modules/P60.3_last_ninja_moods"
mod_data4:                          
	incbin	"data/modules/P60.4_deeper_gates_of_doh"
mod_data5:                          
	incbin	"data/modules/P60.5_mazemania(pink)"
mod_data6:                          
	incbin	"data/modules/P60.6_gone_too_soon.."
mod_data7:                          
	incbin	"data/modules/P60.7_enough_memory?.pre"
mod_data8:                          
	incbin	"data/modules/P60.8_an_apology"
mod_data9:                          
	incbin	"data/modules/P60.9_backbackbackback"
mod_data10:                         
	incbin	"data/modules/P60.a_time_to_forget"

mod_smpl9:
	incbin	"data/modules/smp.9_backbackbackback.term"
even
mod_smpl10:
	incbin	"data/modules/smp.a_time_to_forget.term"
even
