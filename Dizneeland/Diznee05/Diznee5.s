...
;|                                                                      |
;|                                                                      |
;| code by Moon/ABYSS                                     December 1994 |
;------------------------------------------------------------------------
determblink=0
usesection=1
...
Copscreen_text:
	...
	dc.l	$01900856	;colour textfadeeffect
	dc.l	$01920856
	dc.l	$01940856
	dc.l	$01b00745
	dc.l	$01b20745
...
titlecol:;destination
	dc.w	$0645,$0fda,$0ec8,$0eb6
	dc.w	$0ea5,$0e94,$0e83,$0e73
	dc.w	$0d63,$0c53,$0b43,$0933
	dc.w	$0722,$0522,$0422,$0322
	dc.w	$0fff,$0545,$0dee,$0cdd
	dc.w	$0bcc,$0abc,$0aab,$099a
	dc.w	$0989,$0879,$0878,$0767
	dc.w	$0756,$0545,$0535,$0434
;	dc.w $224,$EFF,$CEE,$BDD,$ACC,$9BB,$8AA,$799
;	dc.w $689,$578,$467,$356,$345,$234,$325,$212
;	dc.w $620,$E52,$A52,$FCA,$433,$544,$655,$766
;	dc.w $877,$988,$A99,$BAA,$CBB,$DCC,$EEE,$FFF
...
titlepic:	incbin	"data/titlepic5.blt"
dcb.b	40*5*16,0
...
mod_smpl1:
	incbin	"data/modules/smp.1_sweet_seduction.term"
even
mod_smpl2:
	incbin	"data/modules/smp.2_led_storm.term"
even
mod_smpl3:
	incbin	"data/modules/smp.3_personal_fairlights.term"
even
mod_smpl4:
	incbin	"data/modules/smp.4_bionic_impressions.term"
even
mod_smpl5:
	incbin	"data/modules/smp.5_just_to_funk.term"
even
mod_smpl6:
	incbin	"data/modules/smp.6_kunitokys_theme.term"
even
mod_smpl7:
	incbin	"data/modules/smp.7_walk_a_bout-remix.term"
even
mod_smpl8:
	incbin	"data/modules/smp.8_mr.delay is back?.term"
even
...
mod_data1:
	incbin	"data/modules/P60.1_sweet_seduction"
mod_data2:				
	incbin	"data/modules/P60.2_led_storm"
mod_data3:				
	incbin	"data/modules/P60.3_personal_fairlights"
mod_data4:				
	incbin	"data/modules/P60.4_bionic_impressions"
mod_data5:				
	incbin	"data/modules/P60.5_just_to_funk"
mod_data6:				
	incbin	"data/modules/P60.6_kunitokys_theme"
mod_data7:				
	incbin	"data/modules/P60.7_walk_a_bout-remix"
mod_data8:				
	incbin	"data/modules/P60.8_mr.delay is back?"
mod_data9:				
	incbin	"data/modules/P60.9_chippy story remix"
mod_data10:				
	incbin	"data/modules/P60.a_lament for atlantis"

mod_smpl9:
	incbin	"data/modules/smp.9_chippy story remix.term"
even
mod_smpl10:
	incbin	"data/modules/smp.a_lament for atlantis.term"
even
...
planesize=64*256
mod_smplX:	ds.b	115000-75776	;(75776=size planeborder+planeadr)
;max length od smpl.firstmodules should be 39224
ds.b	37000	;special arrangement for dizzy 5
