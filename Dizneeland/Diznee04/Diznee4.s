...
;|                                                                      |
;|                                                                      |
;| code by Moon/ABYSS                                     November 1994 |
;------------------------------------------------------------------------
determblink=0
usesection=1
...
titlepic:	incbin	"data/Titlepic4.blt"
dcb.b	40*5*16,0

mod_smpl1:
	incbin	"data/modules/SMP.1_beyond_voyage.term"
even
mod_smpl2:
	incbin	"data/modules/SMP.2_xality.term"
even
mod_smpl3:
	incbin	"data/modules/SMP.3_classic_tunes.term"
even
mod_smpl4:
	incbin	"data/modules/SMP.4_springtime.term"
even
mod_smpl5:
	incbin	"data/modules/SMP.5_hysteria_94-remix.term"
even
mod_smpl6:
	incbin	"data/modules/SMP.6_lsd_ninja.term"
even
...
mod_data1:
	incbin	"data/modules/P60.1_beyond_voyage"
mod_data2:				
	incbin	"data/modules/P60.2_xality"
mod_data3:				
	incbin	"data/modules/P60.3_classic_tunes"
mod_data4:				
	incbin	"data/modules/P60.4_springtime"
mod_data5:				
	incbin	"data/modules/P60.5_hysteria_94-remix"
mod_data6:				
	incbin	"data/modules/P60.6_lsd_ninja"
mod_data7:				
	incbin	"data/modules/P60.7_journey_part-2"
mod_data8:				
	incbin	"data/modules/P60.8_summertime-part_2"
mod_data9:				
	incbin	"data/modules/P60.9_november_'64"
mod_data10:				
	incbin	"data/modules/P60.a_path_of_harmony"

mod_smpl7:
	incbin	"data/modules/SMP.7_journey_part-2.term"
even
mod_smpl8:
	incbin	"data/modules/SMP.8_summertime-part_2.term"
even
mod_smpl9:
	incbin	"data/modules/SMP.9_november_'64.term"
even
mod_smpl10:
	incbin	"data/modules/SMP.a_path_of_harmony.term"
even
...
mascc:	incbin	"data/masc/doublespiral.masc"
